...
@NgModule({
  declarations: [DataTable, DataTableColumn, DataTableRow, DataTablePagination, DataTableHeader],
  imports     : [],
  exports     : [DataTable, DataTableColumn, DataTableRow, DataTablePagination, DataTableHeader],
})
